...
/**
 * cgroup_priv_createkey - obtain a new cgroup_priv lookup key
 ...
 * The free() function associated with the lookup key must use RCU to free
 * private data.
 *
 * Returns:
 ...
 */
int
cgroup_priv_createkey(void (*free)(struct kref *r))
{
	int ret;
...
EXPORT_SYMBOL_GPL(cgroup_priv_createkey);
